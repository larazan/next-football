...
const Position = () => {
  return (
    <>
        ...
        <div title="Kiper" className="gk">
          <span className="inline-block px-2 py-1 text-xs text-white">GK</span>
        </div>
        <div title="Bek Kanan" className="rb">
          <span className="inline-block px-2 py-1 text-xs text-white">RB</span>
        </div>
        <div title="Bek Tengah" className="cb">
          <span className="inline-block px-2 py-1 text-xs text-white">CB</span>
        </div>
        <div title="Bek Kiri" className="lb">
          <span className="inline-block px-2 py-1 text-xs text-white">LB</span>
        </div>
        <div title="Gelandang Bertahan Tengah" className="dm">
          <span className="inline-block px-2 py-1 text-xs text-white">DM</span>
        </div>
        <div title="Gelandang Kanan" className="rm">
          <span className="inline-block px-2 py-1 text-xs text-white">RM</span>
        </div>
        ...
        <div title="Sayap Kanan" className="rw">
          <span className="inline-block px-2 py-1 text-xs text-white">RW</span>
        </div>
