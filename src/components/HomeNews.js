      ...
      <div className="h-max mx-auto w-full lg:w-1/2 flex flex-col space-y-4 md:px-4 py-5 md:py-4 lg:px-0 justify-center2 items-center2 bg-[#f5f7f9]">
        <div className="flex space-x-2 px-2 lg:px-0">
          ...
          <button className="flex rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200">
            <span className=" font-semibold text-[#002f6c] leading-tight text-sm">News</span>
          </button>
          <button className="flex rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200">
            <span className=" font-semibold text-[#002f6c] leading-tight text-sm">Club</span>
          </button>
          <button className="flex rounded px-2 py-1 items-center bg-blue-100 hover:bg-blue-200">
        ...
        <div className="flex flex-row justify-between px-2 mx-auto w-full md:w-12/12 space-x-6 items-center">
            ...
            <span className=" font-semibold text-[#002f6c] leading-tight">All News</span>
          </Link>
        </div>
      </div>
    </>
