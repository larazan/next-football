    ...
    <>
      <footer className="flex flex-col space-y-1 bg-[#dc052d] max-h-screen">
        ...
        <div className="flex mx-auto  w-11/12 md:w-9/12 py-4 justify-center items-center">
            <div className="container2 grid grid-cols-2 mx-auto gap-x-7 gap-y-8 sm:grid-cols-3 md:grid-cols-4 text-white">
        ...
        <div className="flex flex-col space-y-6 mx-auto text-white py-6 w-11/12 md:w-7/12 justify-center items-center">
            ...
            <div className="flex justify-around space-x-4">
                ...
                <Link href={"/"}>
                    <span className="font-bold text-sm text-white">Allianz Arena</span>
                </Link>
                <Link href={"/"}>
