    ...
    <>
      <footer className="flex flex-col space-y-1 bg-[#dc052d] max-h-screen">
        ...
        <div className="flex mx-auto  w-11/12 md:w-9/12 py-4 justify-center items-center">
            <div className="container2 grid grid-cols-2 mx-auto gap-x-3 gap-y-8 sm:grid-cols-3 md:grid-cols-4 text-white">
		...
		<div className="flex flex-col space-y-1">
			...
			<div className="flex flex-col font-thin space-y-1 text-sm dark:text-gray-400">
				...
				<a rel="noopener noreferrer" href="#">Hover, Focus, &amp; Other</a>
        ...
        <div className="flex justify-between mx-auto text-white py-6 w-11/12 md:w-11/12  items-center">
            <div className="flex flex-col">
                ...
                <div>
                <span className="text-xs text-white">©&nbsp;FC Bayern München AG&nbsp;–&nbsp;2023</span>
                </div>
            </div>
            <div>
                <Link href={"/"}>
