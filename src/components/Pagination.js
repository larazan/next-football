...
export default function Pagination() {
  return (
    <>
      <div className="flex flex-wrap items-center justify-center mx-auto w-9/12 mt-12 mb-10 space-x-1 space-y-0 md:space-y-0">
        <Link 
          className="rounded px-3 py-1.5 mb-2 md:mb-0 text-center text-sm font-medium flex justify-center items-center text-gray-900 bg-white border border-[#E4E4E4]"
          href={""}
        >
            Page 2 of 277
        </Link>
        <Link
          href={""}
          className="flex border mb-2 border-[#E4E4E4] bg-white rounded p-1 text-[#191919]"
        ...
        <Link
          className="rounded px-3 py-1.5 mb-2 text-center text-sm font-medium flex justify-center items-center text-white bg-[#dc052d]"
          href="/blog?category=All%20Categories&amp;page=1"
        >
          1
        </Link>
        <Link
          className="rounded px-3 py-1.5 mb-2 text-center text-sm font-medium flex justify-center items-center text-gray-900 bg-white border border-[#E4E4E4]"
        ...
        <Link
          className="rounded px-3 py-1.5 mb-2 text-center text-sm font-medium hidden md:flex justify-center items-center text-gray-900 bg-white border border-[#E4E4E4]"
        ...
        <Link
          className="rounded px-3 py-1.5 mb-2 text-center text-sm font-medium flex justify-center items-center text-gray-900 bg-white border border-[#E4E4E4]"
          href="/blog?category=All%20Categories&amp;page=10"
        >
          10
        </Link>
        <Link
          className="rounded px-3 py-1.5 mb-2 text-center text-sm font-medium flex justify-center items-center text-gray-900 bg-white border border-[#E4E4E4]"
          href="/blog?category=All%20Categories&amp;page=20"
        >
          20
        </Link>
        <button
          className="mb-2 bg-white border border-[#E4E4E4] rounded p-1 text-[#191919] disabled:text-[#A3A3A3] disabled:cursor-not-allowed"
