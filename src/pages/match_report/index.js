    ...
    <>
      ...
      <div className="h-max flex flex-col py-0 bg-[#f5f7f9]">
        <div className="flex flex-col py-4 px-6 space-y-1 mx-auto w-full ">
          <div>
            <span className="text-[#dc052d] text-xs font-bold capitalize">
