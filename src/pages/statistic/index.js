      ...
      <div className="h-max flex flex-col py-0 bg-[#f5f7f9]">
        <div className="flex flex-col py-4 px-6 space-y-1 mx-auto w-full ">
          ...
          {statistics.map((data,index) => {
            return (
                <>
                <div className="flex w-full justify-between items-center h-10 py-1.5">
            <div className="flex w-1/6">
                <div>
                    <span className="text-sm font-bold text-[#002f6c]">{data.home}</span>
                </div>
            </div>
            <div className="w-4/6">
                <div className="flex w-full mx-auto justify-center">
                    <span className="text-sm font-bold text-[#002f6c]">{data.title}</span>
                </div>
            </div>
            <div className="flex w-1/6 justify-end">
            <div>
                    <span className="text-sm font-bold text-[#002f6c]">{data.away}</span>
                </div>
            </div>
          </div>
                </>
